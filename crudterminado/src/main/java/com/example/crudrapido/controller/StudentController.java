...
public class StudentController {
    ...
    // public ResponseEntity<Student> getBId(@PathVariable("studentId") Long
    // studentId) {
    ...
    public String searchStudentById(@RequestParam("id") Long id, Model model) {
        Student student = studentService.getStudent(id);
        model.addAttribute("students", studentService.getStudents()); // Agregar la lista de estudiantes al modelo
        model.addAttribute("student", student); // Agregar el estudiante buscado al modelo
        return "students"; // HTML template to display both the list of students and the searched student
    }
    ...
    public String updateStudent(@PathVariable Long id, @ModelAttribute("student") Student updatedStudent) {
        ...
        if (existingStudent != null) {
            // Actualizar los datos del estudiante existente con los datos del estudiante
            // actualizado
